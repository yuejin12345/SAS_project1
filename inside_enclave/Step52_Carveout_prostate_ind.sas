...
%MACRO print_stuff(printlog=);
 ...
 proc printto log="&vrdc_logs./C_log_Step10_Carveout_&project_key._i_&RIFString._YJ_&logdate..log"; run;
 %END;
%MEND print_stuff;
        ...
        %DO setting_counter=1 %to &settings_length;
           ...
           * rename Rendering NPI and SPECIALTY CODE if setting is not CAR or DME
            ...
            * Create the carveout (=identify the monthly files);
            DATA &perm_lib..X_&project_key._i_CARV_&this_setting_name._&current_year.&current_month.;
...
data &perm_lib..&stub_prefix._&project_key._i_CAR_&RIFString;   
set &perm_lib..X_&project_key._i_CARV_CAR_:  (drop=setting);
...
data &perm_lib..&stub_prefix._&project_key._i_OUT_&RIFString;                                                   
set &perm_lib..X_&project_key._i_CARV_OUT_:   (drop=setting ORDRNG_PHYSN_NPI) ;
*delete denied claims;
...
data &perm_lib..&stub_prefix._&project_key._i_CAR_&RIFString._c;   
set &perm_lib..&stub_prefix._&project_key._i_CAR_&RIFString;
...
data &perm_lib..&stub_prefix._&project_key._i_&RIFString. (keep = icd_group1 icd_group2 setting BENE_ID CLM_THRU_DT encounter: rndrng_npi exp_rfr_npi rev_RNDRNG_PHYSN_NPI claim_RNDRNG_PHYSN_NPI OP_PHYSN_NPI SRVC_LOC_NPI_NUM AT_PHYSN_NPI OT_PHYSN_NPI ORG_NPI_NUM PRF_PHYSN_NPI) ;   
set &perm_lib..&stub_prefix._&project_key._i_CAR_&RIFString._c &perm_lib..&stub_prefix._&project_key._i_OUT_&RIFString. /*perm_lib..&stub_prefix._&project_key._DME_&RIFString_p*/ ;
rndrng_npi = npi_hcp; 
...
%MACRO print_stuff(printlog=);
 %IF &printlog = 0 %THEN %DO;
    proc printto;
    run;
    %_log_chk (log=&vrdc_logs./C_log_Step10_Carveout_&project_key._i_&RIFString._YJ_&logdate..log); 
