...
*   print to log for QA check;
    Data _null_;
        PUT "PARAMETERS for project, debug, and time period:"   /  
            ...
            "run_last_year=&run_last_year | run_last_month=&run_last_month | run_rolling_month=&run_rolling_month"/ 
...
*You have 2 options for identifying codes for the macro--enter in list here (option 1) or call from file (option 2);
	...
	*Susie: you need to add drg, icd procedure, hcpcs modifiers here & in step10;
        ...
        * Enter '0' if this grouping is not needed;
		%let incl_hcpcs 		= 'A9606'; 
		%let incl_rev_cntr		= '0'				;	*enter '0' if this grouping is not needed;
		%let incl_ndc			= '50419020801'				; 	
		%let incl_ICD_dx_GROUP1	= '0'				;	*these are ICD dx code groups;
		%let incl_ICD_dx_GROUP2	= '0'				;
...
%let incl_ICD_dx_GROUP1_label = EDIT THIS TO DESCRIBE CONDITION REPRESENTED BY GROUP 1;					
%let incl_ICD_dx_GROUP2_label = EDIT THIS TO DESCRIBE CONDITION REPRESENTED BY GROUP 2;
