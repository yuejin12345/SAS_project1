...
%MACRO print_stuff(printlog=);
 ...
 proc printto log="&vrdc_logs./C_log_Step10_Carveout_&project_key._&RIFString_p._YJ_&logdate..log"; run;
 %END;
%MEND print_stuff;
...
proc sql noprint;
create table &perm_lib..C_NVS_KISQALI_xofigo_bene_id as 
select distinct bene_id
*from &SHARED_LIBRARY..C_NVS_KISQALI_MT21R41_5;   
from &SHARED_LIBRARY..C_NVS_KISQALI_MT&run_last_year.R&run_rolling_month._&run_last_month.;  
quit;
...
***************************************************************************************************************************;
	    ...
	    *Create a claim table that pulls the claim table information for bene_ids that have Xofigo (from this table: &perm_lib..C_NVS_KISQALI_xofigo_bene_id);

            DATA &perm_lib..X_&project_key._p_CARV_&this_setting_name._&current_year.&current_month.;
                merge 
                &claim_table. (&merge_limit. &rename_claim_npi. &rename_claim_type.) 
                &perm_lib..C_NVS_KISQALI_xofigo_bene_id (in=a);
                by bene_id;
                if a;
                run;
            ...
            DATA &perm_lib..X_&project_key._p_CARV_&this_setting_name._&current_year.&current_month.;
                ...
                MERGE
                    &perm_lib..X_&project_key._p_CARV_&this_setting_name._&current_year.&current_month. (in=a)
                    &cline_table. (&rename_cline_npi. &rename_cline_type.) 
                    ;
               ...
               /* npi_hcp  = COALESCEC(&attr_npi_hcp);
                ...
                if setting="OUT" then npi_hcp=COALESCEC(claim_RNDRNG_PHYSN_NPI, OP_PHYSN_NPI, AT_PHYSN_NPI, OT_PHYSN_NPI, SRVC_LOC_NPI_NUM, ORG_NPI_NUM);
...
data &perm_lib..&stub_prefix._&project_key._p_CAR_&RIFString_p;   
set &perm_lib..X_&project_key._p_CARV_CAR_:  (drop=setting);
...
data &perm_lib..&stub_prefix._&project_key._p_OUT_&RIFString_p;                                                   
set &perm_lib..X_&project_key._p_CARV_OUT_:   (drop=setting) ;
*delete denied claims;
...
* run;
* data &perm_lib..&stub_prefix._&project_key._DME_&RIFString_p;   
...
data &perm_lib..&stub_prefix._&project_key._p_CAR_&RIFString._c;   
set &perm_lib..&stub_prefix._&project_key._p_CAR_&RIFString;
...
ORG_NPI_NUM_char = put(ORG_NPI_NUM, 10.);
PRF_PHYSN_NPI_char = put(PRF_PHYSN_NPI, 10.);
drop rev_RNDRNG_PHYSN_NPI claim_RNDRNG_PHYSN_NPI OP_PHYSN_NPI ORDRNG_PHYSN_NPI SRVC_LOC_NPI_NUM AT_PHYSN_NPI OT_PHYSN_NPI ORG_NPI_NUM PRF_PHYSN_NPI;
rename rev_RNDRNG_PHYSN_NPI_char = rev_RNDRNG_PHYSN_NPI
        ...
        ORG_NPI_NUM_char = ORG_NPI_NUM
        PRF_PHYSN_NPI_char = PRF_PHYSN_NPI
;
run;


data &perm_lib..&stub_prefix._&project_key._p_&RIFString. (keep = icd_group1 icd_group2 setting BENE_ID CLM_THRU_DT encounter: imp_rfr_npi rev_RNDRNG_PHYSN_NPI claim_RNDRNG_PHYSN_NPI OP_PHYSN_NPI SRVC_LOC_NPI_NUM AT_PHYSN_NPI OT_PHYSN_NPI ORG_NPI_NUM PRF_PHYSN_NPI) ;   
set &perm_lib..&stub_prefix._&project_key._p_CAR_&RIFString._c &perm_lib..&stub_prefix._&project_key._p_OUT_&RIFString. /*perm_lib..&stub_prefix._&project_key._DME_&RIFString_p*/ ;
imp_rfr_npi = npi_hcp; 
encounter_dt = put(CLM_THRU_DT, DATE9.);
encounter_CLM_ID = CLM_ID;
run;
...
%MACRO print_stuff(printlog=);
 %IF &printlog = 0 %THEN %DO;
    proc printto;
    run;
    %_log_chk (log=&vrdc_logs./C_log_Step10_Carveout_&project_key._&RIFString_p._YJ_&logdate..log); 
